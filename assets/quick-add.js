    ...
    class QuickAddModal extends ModalDialog {
      ...
      show(opener) {
        ...
        fetch(opener.getAttribute('data-product-url'))
          ...
          .then((responseText) => {
            ...
            // Ajout pour redemander au cart drawer de Handle la soumission de formulaire du quick-add, sinon ca va sur /cart
            if (document.querySelector('deployer-cart-drawer')) document.querySelector('deployer-cart-drawer').setProductFormCompatibility();
      ...
      preprocessHTML(productElement) {
        productElement.classList.forEach((classApplied) => {
          if (classApplied.startsWith('color-') || classApplied === 'gradient') this.modalContent.classList.add(classApplied);
        });
